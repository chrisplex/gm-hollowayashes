...
if switcher == 0 {
	...
	//		Super_Text(self.x - 150, self.y - 200, string_to_draw, 30, 330, c_white,  tip, 0.4,  spk, 1, 0.2); 
			done_talking = Super_Text(60,view_midh , text, 35,1000, c_white,  sumbas, 0.4,  audio_quiet, 1, 0.2); 
...
// DOOR IS OPEN
	...
	if spke == true{
			draw_set_halign(fa_center);
	//		Super_Text(self.x - 150, self.y - 200, string_to_draw, 30, 330, c_white,  tip, 0.4,  spk, 1, 0.2); 
			done_talking = Super_Text(60,view_midh , text2, 35,1000, c_white,  sumbas, 0.4,  audio_quiet, 1, 0.2); 
			global.player_freeze = true;
	}
}